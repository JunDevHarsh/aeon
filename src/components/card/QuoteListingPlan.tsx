...
// planType: "comprehensive" | "thirdParty" | "thirdPartyFireAndTheft";
// planTitle: "Motor Comprehensive"
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        <div className="pb-4 md:pb-0 flex flex-col items-start w-full md:w-[60%] border-r-0 md:border-r border-b md:border-b-0 border-solid border-gray-300">
          ...
          <div className="mt-4 pr-0 md:pr-8 w-full">
            {/* List of coverages */}
            <ul className="flex flex-col items-start justify-between w-auto h-auto">
              {benefits
                .slice(
                  0,
                ...
                .map((benefit, index) => (
                  ...
                  >
                    <svg
                      ...
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      className="mt-[3px] min-w-[20px] min-h-[20px]"
                    >
                      <path
            ...
            <div className="mt-7 flex flex-col items-center md:items-end w-full">
              <button
          ...
          <div className="ml-0 md:ml-4 lg:ml-auto flex flex-col items-center justify-start w-full h-full">
            ...
            <div className="mt-4 flex flex-col items-center justify-start w-full lg:w-auto">
              <button
                ...
                className="relative mt-2 lg:mt-0 py-1 lg:py-2.5 px-3.5 lg:px-5 w-full lg:w-auto bg-primary-blue rounded-md lg:rounded-full shadow-[0_1px_2px_0_#C6E4F60D]"
              >
                <span className="text-xl lg:text-2xl text-center font-medium text-white">
                  Buy Now
                </span>
              </button>
              <div className="ml-0 lg:ml-2 mt-4 relative flex items-center justify-center w-full lg:w-auto">
