  ...
  return (
    <div className="relative mx-auto max-w-7xl w-full">
      <div className="block py-6 px-4 lg:pl-8 pr-4 w-full">
        <div className="flex items-center justify-center xl:justify-between gap-x-2 w-full">
          <div className="block px-4 md:px-8 py-10 max-w-4xl w-full h-auto bg-white rounded-[20px] shadow-container">
            <div className="block w-full">
              <h2 className="text-3xl text-center text-primary-black font-bold">
          ...
          <div className="hidden xl:flex items-center justify-center w-auto h-full">
            <img
              src={ManAndWomanImg}
